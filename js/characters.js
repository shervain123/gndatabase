 ...
 function img(){
    ...
    for (i = 0; i < character.length; i++){
        if(character[i].name == cha_name){
            ...
            if(character[i].eas_eg != null) imgs.title = character[i].eas_eg
        }
    }
 }
...
function material(){
    ...
    total.appendChild(material_creator(boss_asc_img,"46x \u00A0\u00A0"+boss_asc))
    ...
    var total =  material_container()
    total.appendChild(material_title("Total"))
    total.appendChild(material_creator(talent_img_1,"3x \u00A0\u00A0\u00A0"+talent_3))
    total.appendChild(material_creator(talent_img_2,"21x \u00A0\u00A0\u00A0"+talent_3))
    total.appendChild(material_creator(talent_img_3,"38x \u00A0\u00A0\u00A0"+talent_3))
    total.appendChild(material_creator(comasc_img_1,"6x \u00A0\u00A0\u00A0"+comasc_3))
